...
def load_config() -> dict[str, Any]:
    ...
    if os.getenv("XAI_VISION_MODEL"):
        xai["vision_model"] = os.getenv("XAI_VISION_MODEL")
    ...
    acct = raw.setdefault("accounting", {})
    if os.getenv("ACCOUNTING_BACKEND"):
        acct["backend"] = os.getenv("ACCOUNTING_BACKEND")
    ...
    raw["security"] = {
        ...
        "widget_key": os.getenv("INVOICEFORGE_WIDGET_KEY", "pk_live_change-me"),
    }

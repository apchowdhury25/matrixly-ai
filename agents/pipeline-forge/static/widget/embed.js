/**
 * Matrixly PipelineForge embed launcher.
 */
(function () {
  ...
  btn.type = "button";
  btn.textContent = "PipelineForge";
  btn.setAttribute("aria-label", "Open PipelineForge");
  btn.style.cssText =
  ...
  btn.addEventListener("click", function () {
    ...
    frameWrap.style.cssText =
      "position:fixed;bottom:72px;right:20px;z-index:99999;width:min(440px,94vw);height:min(680px,82vh);" +
      "border-radius:14px;overflow:hidden;box-shadow:0 16px 48px rgba(0,0,0,0.35);border:1px solid #1e2a3a;";
    var iframe = document.createElement("iframe");
    iframe.title = "PipelineForge";

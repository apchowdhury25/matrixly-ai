...
def load_config() -> dict[str, Any]:
    ...
    if os.getenv("CALENDAR_BACKEND"):
        cal["backend"] = os.getenv("CALENDAR_BACKEND")
    cal["google_calendar_id"] = os.getenv("GOOGLE_CALENDAR_ID", "primary")
    cal["google_credentials_path"] = os.getenv("GOOGLE_CREDENTIALS_PATH", "credentials.json")
    cal["google_token_path"] = os.getenv("GOOGLE_TOKEN_PATH", "token.json")
    cal["calendly_token"] = os.getenv("CALENDLY_API_TOKEN", "")
    cal["calendly_event_type_uri"] = os.getenv("CALENDLY_EVENT_TYPE_URI", "")
    ...
    raw["security"] = {
        ...
        "widget_key": os.getenv("BOOKWISE_WIDGET_KEY", "pk_live_change-me"),
    }

/**
 * Matrixly Starter Pack — floating launcher to open the unified dashboard.
 * <script src=".../embed-pack.js" data-api="https://host:8800" async></script>
 */
(function () {
  ...
  btn.type = "button";
  btn.textContent = "Matrixly Pack";
  btn.setAttribute("aria-label", "Open Matrixly Starter Pack");
  btn.style.cssText =
  ...
  btn.addEventListener("click", function () {
    ...
    frameWrap.style.cssText =
      "position:fixed;bottom:72px;right:20px;z-index:99999;width:min(480px,96vw);height:min(720px,86vh);" +
      "border-radius:14px;overflow:hidden;box-shadow:0 16px 48px rgba(0,0,0,0.35);border:1px solid #1e2a3a;";
    var iframe = document.createElement("iframe");
    iframe.title = "Matrixly Starter Pack";

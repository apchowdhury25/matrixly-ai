/**
 * Matrixly ContentForge launcher — opens embeddable workspace
...
(function () {
  ...
  btn.textContent = "ContentForge";
  btn.setAttribute("aria-label", "Open ContentForge");
  ...
  btn.onclick = function () {
    window.open(API + "/static/workspace/index.html", "_blank", "noopener");
  };

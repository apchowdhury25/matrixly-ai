...
def load_config() -> dict[str, Any]:
    ...
    raw["security"] = {
        "api_key": os.getenv("CONTENTFORGE_API_KEY", "change-me-admin-key"),
        "widget_key": os.getenv("CONTENTFORGE_WIDGET_KEY", "pk_live_change-me"),
    }
...
def brand_voice_text(cfg: dict) -> str:
    ...
    if path.exists():
        return path.read_text(encoding="utf-8")
    return "Professional, clear, practical B2B voice for SMBs."
